"""
Display live status of a running or completed parallel options daily-features
download.

Reads the state file written by stock_options_parallel_download.py.

Usage:
    python scripts/options/stock_options_parallel_status.py
    python scripts/options/stock_options_parallel_status.py --year 2025
    python scripts/options/stock_options_parallel_status.py --year 2025 --watch
        --watch: refresh every 5 seconds (live monitoring)

    python scripts/options/stock_options_parallel_status.py --year 2025 --kill
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Show status of parallel stock options downloads"
    )
    parser.add_argument(
        "--year",
        type=str,
